...
---
Bonjour à tous,
Aujourd’hui nous allons parler de Sonic Pi, un logiciel de musique qui permet de crée des sons.Dans la lancée de la technologie le terme d’algorave est né. Une algorave est une soirée électronique dirigée par un DJ qui code sa musique en direct.
...
Après l’installation, lancez l’exécutable Sonic Pi. Une interface vous sera affichée comme ceci :


![Sonic Pi]({{ site.baseurl }} /assets/capture.png "Interface de Sonic Pi")
